        ...
        <div className="Landing">
          <h1>Oil Change</h1>
            <p>If you have ever forgotten when you changed the oil, simply ran out of room or lost your
              maintenance log book. Don't worry you are not alone, and fortunately there is Oil Change, an
              app that will be the maintenance log book in your pocket. 
              ...
              Just sign up, fill out a log entry, and we will keep a record for you.</p>         
        </div>
    );
}
